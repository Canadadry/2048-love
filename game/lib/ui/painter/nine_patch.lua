...
function nine_patch.load(image, arg1, arg2, arg3, arg4)
    if arg3 == nil and arg4 == nil then
        return nine_patch.loadSameEdge(image, arg1, arg2)
    end
    return nine_patch.loadDiffrntEdge(image, arg1, arg2, arg3, arg4)
end

function nine_patch.loadDiffrntEdge(image, left, top, right, bottom)
...
function nine_patch.loadSameEdge(image, edgeW, edgeH)
    local imageW, imageH = image:getDimensions()
...
function nine_patch.draw(patch, x, y, width, height)
